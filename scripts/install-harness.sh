...
Examples:
  ...
  curl -fsSL https://raw.githubusercontent.com/trankhacthuan/harness_w_u/main/scripts/install-harness.sh | bash -s -- --merge --yes
  curl -fsSL https://raw.githubusercontent.com/trankhacthuan/harness_w_u/main/scripts/install-harness.sh | bash -s -- --merge --refresh-agent-shim --yes
  curl -fsSL https://raw.githubusercontent.com/trankhacthuan/harness_w_u/main/scripts/install-harness.sh | bash -s -- --claude --yes
EOF
}
...
default_cli_base_url() {
  ...
  if [ -n "$release_tag" ] && [ "$release_tag" != "latest" ]; then
    printf 'https://github.com/trankhacthuan/harness_w_u/releases/download/%s\n' "$release_tag"
  else
    printf 'https://github.com/trankhacthuan/harness_w_u/releases/latest/download\n'
  fi
}
...
SOURCE_ROOT=""
SOURCE_MODE="remote"
SOURCE_BASE_URL="${HARNESS_SOURCE_BASE_URL:-https://raw.githubusercontent.com/trankhacthuan/harness_w_u/main}"
